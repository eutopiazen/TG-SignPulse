...
| 环境 | 镜像 |
|------|------|
| 生产 | `ghcr.io/eutopiazen/tg-signpulse:latest` 或 `ghcr.io/eutopiazen/tg-signpulse:v2.2.3` |
| 稳定主干 | `ghcr.io/eutopiazen/tg-signpulse:main` 或 `…:main-<sha>` |
| 预发/开发 | `ghcr.io/eutopiazen/tg-signpulse:dev` |
